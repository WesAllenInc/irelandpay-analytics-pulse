...
try {
  ...
  execSync(
    'npx supabase gen types typescript --project-id "$NEXT_PUBLIC_SUPABASE_PROJECT_ID" --schema public > types/supabase-generated.ts',
    { 
      stdio: 'inherit',
      env: { 
        ...process.env,
  ...
  console.log('📝 Generated types saved to types/supabase-generated.ts');
  ...
  console.log('3. Generate types: supabase gen types typescript --project-id YOUR_PROJECT_ID --schema public > types/supabase-generated.ts');
  process.exit(1);
}
