...
GRANT SELECT ON public.master_data TO authenticated_role;
...
GRANT SELECT ON public.merchant_data TO authenticated_role;
...
GRANT SELECT ON public.merchant_volume TO authenticated_role;
...
GRANT SELECT ON public.estimated_net_profit TO authenticated_role;
...
GRANT SELECT, INSERT, UPDATE ON public.sync_watermarks TO authenticated_role;
...
GRANT SELECT ON public.change_log TO authenticated_role;
...
GRANT SELECT ON public.sync_alerts TO authenticated_role;
...
GRANT SELECT, INSERT, UPDATE ON public.alert_subscriptions TO authenticated_role;
...
GRANT SELECT ON public.upcoming_sync_schedules TO authenticated_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.sync_schedules TO authenticated_role;
...
GRANT SELECT ON public.table_stats TO authenticated_role;
...
GRANT SELECT ON public.slow_queries TO authenticated_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.data_validation_issues TO authenticated_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.data_validation_reports TO authenticated_role;
...
GRANT SELECT ON public.validation_report_summaries TO authenticated_role;
...
GRANT SELECT ON public.open_validation_issues TO authenticated_role;
...
GRANT SELECT ON public.data_freshness TO authenticated_role;
...
GRANT SELECT ON public.sync_queue TO authenticated_role;
